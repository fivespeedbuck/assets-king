...
val GlassBorderLight = Color(0xFFCDD9D5)             // 卡片细边框（对齐碳水大王 outline #CDD9D5）
val SurfaceLight = Color(0xFFF7F8F8)                 // 浅灰白页面背景（对齐碳水大王 container #F7F8F8）
val OutlineLight = Color(0xFFCDD9D5)                 // 输入框边框（对齐碳水大王 outline）
...
val TextSecondaryLight = Color(0xFF4F5D58)           // 对齐碳水大王 on_surface_variant #4F5D58
