...
class NotificationParserTest {
    ...
    @Test
    fun `真实删除样本中的报价发券预告和余额提醒不产生金额`() {
        val junk = listOf(
            "你的现金红包即将过期，你有53元现金红包再不用就来不及了",
            "外卖红包（最高18元）已预留",
            "当前宁波到重庆机票仅¥816，价格近期平稳",
            "您的黑金会员专属保障已生效，如配送超时准时宝赔付最高6元",
            "本月交费34.75元，将于2026年09月11日从支付宝自动扣取",
            "您有235元消费券还未领取",
            "您的账户余额已不足15.00元，请及时充值"
        )

        junk.forEach { assertNull(NotificationParser.parse(it, null).amountCents, "不该进待确认：$it") }
    }
